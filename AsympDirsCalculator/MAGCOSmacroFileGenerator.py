...
class MAGCOSmacroFileGenerator():
    ...
    try:
        # For Python 3.9+
        _MacroFileTemplateLocation = str(pkg_resources.files(__name__) / "magcos_running_scripts/AsymptoticDirection.g4mac")
    except AttributeError:
        # Fallback for older versions
        import pkg_resources as old_pkg_resources
        _MacroFileTemplateLocation = old_pkg_resources.resource_filename(__name__,"magcos_running_scripts/AsymptoticDirection.g4mac")
